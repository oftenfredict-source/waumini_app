...
<div class="app-title">
    <div>
        <h1><i class="fa fa-plus"></i> Record Tithe</h1>
        <p>Submit a member tithe for approval</p>
    </div>
...
<div class="tile">
    <form method="POST" action="{{ route('church.tithes.store') }}">
        ...
        <div class="tile-footer mt-3">
            <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Save Tithe</button>
            <a href="{{ route('church.tithes.index') }}" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
@endsection
