...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                   value="{{ old('name', $branch?->name) }}" required placeholder="e.g. Tabora, Kinondoni">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="code" class="form-control @error('code') is-invalid @enderror"
                   value="{{ old('code', $branch?->code) }}" required placeholder="e.g. TBR, KIN">
            @error('code')<div class="invalid-feedback">{{ $message }}</div>@enderror
            <small class="text-muted">Short code to identify the branch (letters and numbers only).</small>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
    ...
    <div class="col-md-6">
        <div class="form-check mt-2">
            ...
            <label class="form-check-label" for="is_headquarters">Set as Headquarters</label>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-check mt-2">
