...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label>Deceased / Affected Name *</label>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label>Related Church Member</label>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label>Contribution Start *</label>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <textarea name="family_details" rows="3" class="form-control @error('family_details') is-invalid @enderror"
                placeholder="Brief family information">{{ old('family_details', $event?->family_details) }}</textarea>
    ...
    @if($isCreate)
        <div class="col-md-12">
            <div class="form-group">
                <label>Members to Track (optional)</label>
                <p class="text-muted small mb-2">Leave all unchecked to track all active members.</p>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea name="fund_usage" rows="3" class="form-control @error('fund_usage') is-invalid @enderror"
                    placeholder="How the collected funds were used">{{ old('fund_usage', $event?->fund_usage) }}</textarea>
