...
<h4 class="tile-title">Line Items</h4>
...
<h4 class="tile-title">Funding Allocations (from approved offerings)</h4>
<p class="text-muted small mb-3">
    Available balances are calculated from approved offerings and approved pledge payments. Pledge payments are included under General.
    <strong>Total available: TZS {{ number_format(array_sum($availableAmounts), 2) }}</strong>
</p>
<div class="row">
    @foreach($offeringTypes as $type)
        @php
        ...
        <div class="col-md-4 mb-2">
            <div class="form-group">
                ...
                <small class="text-muted d-block">
                    Available: TZS {{ number_format($available, 2) }}
                </small>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function reindex() {
        ...
        rows.forEach((row, idx) => {
            ...
            // We keep input names as-is for now; the simplest approach is to rebuild.
        });
    }
    ...
    addBtn.addEventListener('click', function () {
        ...
        // Clone first row and replace indices by regex; keep it simple for MVP.
