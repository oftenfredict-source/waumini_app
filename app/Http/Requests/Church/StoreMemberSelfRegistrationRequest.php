...
class StoreMemberSelfRegistrationRequest extends FormRequest
{
    ...
    {
        $service = app(ChurchContextService::class);

        return $service->current() ?? $service->resolveFromRequest($this);
    }
}
