...
class UpdatePromiseGuestRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->can('update', $this->route('promise_guest'));
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'status' => ['required', Rule::enum(PromiseGuestStatus::class)],
